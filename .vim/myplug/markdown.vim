inoremap <buffer> <Leader>e **<Esc>i
inoremap <buffer> <Leader>s ****<Esc>hi
inoremap <buffer> <Leader>st ~~~~<Esc>hi
inoremap <buffer> <Leader>o 1. 
inoremap <buffer> <Leader>u * 
inoremap <buffer> <Leader>bq > 
inoremap <buffer> <Leader>ic ``<Esc>i
